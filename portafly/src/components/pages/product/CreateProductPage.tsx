          ...
          <CardBody>
            <Form onSubmit={onSubmit}>
              ...
              <FormGroup
                ...
                fieldId="system_name"
                helperText={t('system_name.helper')}
              ...
              >
                <TextInput
                  ...
                  onBlur={onBlur}
                  placeholder={t('system_name.placeholder')}
                />
              </FormGroup>
              ...
              <ActionGroup>
                <Button type="submit" isDisabled={isPending || !isValid} variant="primary">{t('shared:shared_elements.create_button')}</Button>
